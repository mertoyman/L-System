...
namespace octet {
  ...
  public:
    ...
    void app_init() {
      ...
      diffuse = ambient = resources::get_texture_handle(GL_RGB, "!bricks"); // "!bricks"  // 1
      //emission = resources::get_texture_handle(GL_RGB, "#00ffff");   // #000000           // 2
      emission = resources::get_texture_handle(GL_RGB, "#ff0000");   // #ffffff"          //3
	  specular = resources::get_texture_handle(GL_RGB, "#ff0000");   // #000000           // 2
    }
